...
1. Excel — data cleaning, pivot tables, initial KPI calculation
2. SQL (PostgreSQL) — aggregation, ranking, segmentation, and cohort analysis (retail_sales_analysis.sql)
3. Power BI — interactive dashboard with KPI cards, category/regional breakdowns, monthly trend, and year/region filters
